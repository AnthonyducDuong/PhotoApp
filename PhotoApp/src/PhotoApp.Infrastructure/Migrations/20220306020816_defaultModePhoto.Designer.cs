...
namespace PhotoApp.Infrastructure.Migrations
{
    ...
    [Migration("20220306020816_defaultModePhoto")]
    partial class defaultModePhoto
    {
            ...
            modelBuilder.Entity("PhotoApp.Domain.Entities.RoleEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8cacad78-f8d7-47af-9734-b7d91d94b780"),
                            ConcurrencyStamp = "1",
                            Name = "ADMIN",
                        ...
                        new
                        {
                            Id = new Guid("02f980f2-6f7c-4422-a7fd-96c5aa2ac007"),
                            ConcurrencyStamp = "2",
                            Name = "USER",
                            NormalizedName = "User"
                        });
